...
const Dashboard = () => {
  ...
  const handleQuickLink = (tab: string, message: string) => {
    setActiveTab(tab);
    alert(message);
  };
  ...
  const saveUserData = async (userId: string, data: { name: string; email: string; avatarUrl: string }) => {
    const db = getFirestore();
    const userDoc = doc(db, "users", userId);
              ...
              <CardContent>
                <div className="space-y-2">
                  <Button
                    ...
                    size="sm"
                    onClick={() => handleQuickLink('announcements', 'Redirected to Announcements')}
                  >
                  ...
                  <Button
                    ...
                    className="w-full justify-start"
                    size="sm"
                    onClick={() => handleQuickLink('schedule', 'Redirected to Chapel Rules & Guidelines')}
                  >
                    <BookOpen className="h-4 w-4 mr-2" />
                  ...
                  <Button
                    ...
                    className="w-full justify-start"
                    size="sm"
                    onClick={() => handleQuickLink('overview', 'Redirected to Meet the Chaplains')}
                  >
                  ...
                  <Button
                    ...
                    className="w-full justify-start"
                    size="sm"
                    onClick={() => handleQuickLink('events', 'Redirected to Register for Special Event')}
                  >
